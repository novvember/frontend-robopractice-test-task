# Тестовое задание на буткемп от red_mad_robot для frontend-разработчика

Сам буткемп: https://upgrade.redmadrobot.com/bootcamp

### Демо
https://novvember.github.io/frontend-robopractice-test-task/
